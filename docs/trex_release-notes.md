...
* Sandboxed Extensions are Tableau dashboard extensions that are not permitted to external network requests. Available for testing with Tableau 2019.3. Fully supported in Tableau 2019.4.
